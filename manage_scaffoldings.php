...
<div class="wrapper">
    ...
    <div class="main-container">
        ...
        $query = "SELECT * FROM scaffoldings";
        ...
        if (isset($_POST['add_item'])) {
            ...
            $imagePath = 'uploads2/' . $imageName; // Change 'uploads/' to your desired directory
            ...
            if (!in_array($fileExtension, $allowedExtensions)) {
                ...
                echo '<script>window.location.href = "manage_scaffoldings.php";</script>';
                exit();
            }
            ...
            $query = "INSERT INTO scaffoldings (title2, category2, image_path2) VALUES ('$title2', '$category2', '$imagePath')";
        ...
        if (isset($_POST['delete_item'])) {
            ...
            $query = "SELECT image_path2 FROM scaffoldings WHERE id2 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $row = mysqli_fetch_assoc($result);
            $imagePath = $row['image_path2'];

            // Delete the item from the database
            $query = "DELETE FROM scaffoldings WHERE id2 = '$itemID'";
            mysqli_query($connection, $query);
        ...
        if (isset($_POST['update_item'])) {
            ...
            $itemID = $_POST['item_id'];
            $updatedTitle = $_POST['title2'];
            $updatedCategory = $_POST['category2'];

            // Retrieve the previous image path for the item
            $query = "SELECT image_path2 FROM scaffoldings WHERE id2 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $previousImagePath = mysqli_fetch_assoc($result)['image_path2'];
            ...
            if ($_FILES['image']['name']) {
                ...
                $query = "UPDATE scaffoldings SET title2 = '$updatedTitle', category2 = '$updatedCategory', image_path2 = '$imagePath' WHERE id2 = '$itemID'";
            } else {
                // Update the item without changing the image path
                $query = "UPDATE scaffoldings SET title2 = '$updatedTitle', category2 = '$updatedCategory' WHERE id2 = '$itemID'";
            }
        ...
        <div class="container mt-5">
            ...
            <table class="table">
                ...
                <?php foreach ($portfolioItems as $item): ?>
                    <tr>
                        <td><img src="<?php echo $item['image_path2']; ?>" alt="" width="100"></td>
                        <td><?php echo $item['title2']; ?></td>
                        <td><?php echo $item['category2']; ?></td>
                        <td>
                            <form method="POST" style="display: inline;">
                                <input type="hidden" name="item_id" value="<?php echo $item['id2']; ?>">
                                <button type="submit" class="btn btn-danger" name="delete_item">Delete</button>
                            </form>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateModal<?php echo $item['id2']; ?>">Update</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            ...
            <!-- Update modal -->
            <?php foreach ($portfolioItems as $item): ?>
                <div class="modal fade" id="updateModal<?php echo $item['id2']; ?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?php echo $item['id2']; ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel<?php echo $item['id2']; ?>">Update Portfolio Item</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="title2">Title:</label>
                                        <input type="text" class="form-control" name="title2" value="<?php echo $item['title2']; ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="category2">Category:</label>
                                        <select class="form-control" name="category2" value="<?php echo $item['category2']; ?> " required>
                                            <option value="all" selected>All</option>
                                            <option value="Top Selling">Top selling</option>
                                            <option value="Budget Friendly">Budget Friendly</option>
