...
<div class="wrapper">
    ...
    <div class="main-container">
        ...
        if (isset($_POST['add_item'])) {
            ...
            $imagePath = 'uploads3/' . $imageName; // Change 'uploads/' to your desired directory
            ...
            if (!in_array($fileExtension, $allowedExtensions)) {
                ...
                echo '<script>window.location.href = "manage_plumbings.php";</script>';
                exit();
            }
            ...
            $query = "INSERT INTO plumbings (title3, category3, image_path3) VALUES ('$title3', '$category3', '$imagePath')";
        ...
        if (isset($_POST['delete_item'])) {
            ...
            $query = "SELECT image_path3 FROM plumbings WHERE id3 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $row = mysqli_fetch_assoc($result);
            $imagePath = $row['image_path3'];

            // Delete the item from the database
            $query = "DELETE FROM plumbings WHERE id3 = '$itemID'";
            mysqli_query($connection, $query);
        ...
        if (isset($_POST['update_item'])) {
            ...
            $itemID = $_POST['item_id'];
            $updatedTitle = $_POST['title3'];
            $updatedCategory = $_POST['category3'];

            // Retrieve the previous image path for the item
            $query = "SELECT image_path3 FROM plumbings WHERE id3 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $previousImagePath = mysqli_fetch_assoc($result)['image_path3'];
            ...
            if ($_FILES['image']['name']) {
                ...
                $query = "UPDATE plumbings SET title3 = '$updatedTitle', category3 = '$updatedCategory', image_path3 = '$imagePath' WHERE id3 = '$itemID'";
            } else {
                // Update the item without changing the image path
                $query = "UPDATE plumbings SET title3 = '$updatedTitle', category3 = '$updatedCategory' WHERE id3 = '$itemID'";
            }
        ...
        <div class="container mt-5">
            <h2>Manage Plumbing Contents</h2>
            ...
            <table class="table">
                ...
                <?php foreach ($portfolioItems as $item): ?>
                    <tr>
                        <td><img src="<?php echo $item['image_path3']; ?>" alt="" width="100"></td>
                        <td><?php echo $item['title3']; ?></td>
                        <td><?php echo $item['category3']; ?></td>
                        <td>
                            <form method="POST" style="display: inline;">
                                <input type="hidden" name="item_id" value="<?php echo $item['id3']; ?>">
                                <button type="submit" class="btn btn-danger" name="delete_item">Delete</button>
                            </form>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateModal<?php echo $item['id3']; ?>">Update</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            ...
            <!-- Update modal -->
            <?php foreach ($portfolioItems as $item): ?>
                <div class="modal fade" id="updateModal<?php echo $item['id3']; ?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?php echo $item['id3']; ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel<?php echo $item['id3']; ?>">Update Portfolio Item</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="title3">Title:</label>
                                        <input type="text" class="form-control" name="title3" value="<?php echo $item['title3']; ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="category3">Category:</label>
                                        <select class="form-control" name="category3" value="<?php echo $item['category3']; ?> " required>
                                            <option value="all" selected>All</option>
                                            <option value="Top Selling">Top selling</option>
                                            <option value="Budget Friendly">Budget Friendly</option>
