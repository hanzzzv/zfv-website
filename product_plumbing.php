        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                <?php foreach ($portfolioItems as $item): ?>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo strtolower($item['category3']); ?>">
                        <div class="portfolio-wrap">
                            <img src="<?php echo $item['image_path3']; ?>" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><?php echo $item['title3']; ?></h4>
                                <p><?php echo $item['category3']; ?></p>
                                <div class="portfolio-links">
                                    <a href="<?php echo $item['image_path3']; ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?php echo $item['title3']; ?>"><i class="bx bx-plus"></i></a>
