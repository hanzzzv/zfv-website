...
<div class="wrapper">
    ...
    <div class="main-container">
        ...
        if (isset($_POST['add_item'])) {
            ...
            $imagePath = 'uploads6/' . $imageName; // Change 'uploads/' to your desired directory
            ...
            if (!in_array($fileExtension, $allowedExtensions)) {
                ...
                echo '<script>window.location.href = "manage_cctvs.php";</script>';
                exit();
            }
            ...
            $query = "INSERT INTO cctvs (title6, category6, image_path6) VALUES ('$title6', '$category6', '$imagePath')";
        ...
        if (isset($_POST['delete_item'])) {
            ...
            $query = "SELECT image_path6 FROM cctvs WHERE id6 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $row = mysqli_fetch_assoc($result);
            $imagePath = $row['image_path6'];

            // Delete the item from the database
            $query = "DELETE FROM cctvs WHERE id6 = '$itemID'";
            mysqli_query($connection, $query);
        ...
        if (isset($_POST['update_item'])) {
            ...
            $itemID = $_POST['item_id'];
            $updatedTitle = $_POST['title6'];
            $updatedCategory = $_POST['category6'];

            // Retrieve the previous image path for the item
            $query = "SELECT image_path6 FROM cctvs WHERE id6 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $previousImagePath = mysqli_fetch_assoc($result)['image_path6'];
            ...
            if ($_FILES['image']['name']) {
                ...
                $query = "UPDATE cctvs SET title6 = '$updatedTitle', category6 = '$updatedCategory', image_path6 = '$imagePath' WHERE id6 = '$itemID'";
            } else {
                // Update the item without changing the image path
                $query = "UPDATE cctvs SET title6 = '$updatedTitle', category6 = '$updatedCategory' WHERE id6 = '$itemID'";
            }
        ...
        <div class="container mt-5">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title6" required>
                </div>
                <div class="form-group">
            ...
            <table class="table">
                ...
                <?php foreach ($portfolioItems as $item): ?>
                    <tr>
                        <td><img src="<?php echo $item['image_path6']; ?>" alt="" width="100"></td>
                        <td><?php echo $item['title6']; ?></td>
                        <td><?php echo $item['category6']; ?></td>
                        <td>
                            <form method="POST" style="display: inline;">
                                <input type="hidden" name="item_id" value="<?php echo $item['id6']; ?>">
                                <button type="submit" class="btn btn-danger" name="delete_item">Delete</button>
                            </form>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateModal<?php echo $item['id6']; ?>">Update</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            ...
            <!-- Update modal -->
            <?php foreach ($portfolioItems as $item): ?>
                <div class="modal fade" id="updateModal<?php echo $item['id6']; ?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?php echo $item['id6']; ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel<?php echo $item['id6']; ?>">Update Portfolio Item</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="title6">Title:</label>
                                        <input type="text" class="form-control" name="title6" value="<?php echo $item['title6']; ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="category6">Category:</label>
                                        <select class="form-control" name="category6" value="<?php echo $item['category6']; ?> " required>
                                            <option value="all" selected>All</option>
                                            <option value="Top Selling">Top selling</option>
                                            <option value="Budget Friendly">Budget Friendly</option>
