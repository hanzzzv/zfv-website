...
$sql = "SELECT * FROM tblusers WHERE users_stamp_verification IS NOT NULL AND users_type <> 'manager'";
...
<div class="container my-3">
    ...
    ?>
    <hr>
    <h1> Verified Reports of Carpool Users </h1>
    <hr>
    <table class="table table-striped" style="background-image: linear-gradient(to bottom, #f6d365, #fda085); color: darkgreen;">
        <thead>
        <tr>
            <th scope="col">no.</th>
