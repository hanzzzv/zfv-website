...
class PHPMailer
{
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        if (empty($this->Sender) && !empty($sendmail_from_value)) {
            //PHP settings has a sender address we can use
    ...
    {
        //It's not possible to use shell commands safely (which appends the mail() function) without escapeshellarg,
     ...
     * Picks shortest of Q, B, or none. Result appends folding if needed.
