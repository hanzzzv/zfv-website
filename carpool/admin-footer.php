...
<head>
    ...
    <link rel="stylesheet" href="../myfooter/fonts/icomoon/style.css">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../myfooter/css/bootstrap.min.css">

    <!-- Style CSS -->
    <link rel="stylesheet" href="../myfooter/css/style.css">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 pr-md-5">
                <a href="#" class="footer-site-logo d-block mb-4">HCV Carpool</a>
...
<script src="../myfooter/js/jquery-3.3.1.min.js"></script>
<script src="../myfooter/js/popper.min.js"></script>
<script src="../myfooter/js/bootstrap.min.js"></script>
</body>
</html>