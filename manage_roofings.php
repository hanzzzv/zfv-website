...
<div class="wrapper">
    ...
    <div class="main-container">
        ...
        if (isset($_POST['add_item'])) {
            ...
            $imagePath = 'uploads4/' . $imageName; // Change 'uploads/' to your desired directory
            ...
            if (!in_array($fileExtension, $allowedExtensions)) {
                ...
                echo '<script>window.location.href = "manage_roofings.php";</script>';
                exit();
            }
            ...
            $query = "INSERT INTO roofings (title4, category4, image_path4) VALUES ('$title4', '$category4', '$imagePath')";
        ...
        if (isset($_POST['delete_item'])) {
            ...
            $query = "SELECT image_path4 FROM roofings WHERE id4 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $row = mysqli_fetch_assoc($result);
            $imagePath = $row['image_path4'];

            // Delete the item from the database
            $query = "DELETE FROM roofings WHERE id4 = '$itemID'";
            mysqli_query($connection, $query);
        ...
        if (isset($_POST['update_item'])) {
            ...
            $itemID = $_POST['item_id'];
            $updatedTitle = $_POST['title4'];
            $updatedCategory = $_POST['category4'];

            // Retrieve the previous image path for the item
            $query = "SELECT image_path4 FROM roofings WHERE id4 = '$itemID'";
            $result = mysqli_query($connection, $query);
            $previousImagePath = mysqli_fetch_assoc($result)['image_path4'];
            ...
            if ($_FILES['image']['name']) {
                ...
                $query = "UPDATE roofings SET title4 = '$updatedTitle', category4 = '$updatedCategory', image_path4 = '$imagePath' WHERE id4 = '$itemID'";
            } else {
                // Update the item without changing the image path
                $query = "UPDATE roofings SET title4 = '$updatedTitle', category4 = '$updatedCategory' WHERE id4 = '$itemID'";
            }
        ...
        <div class="container mt-5">
            <h2>Manage Roofings </h2>
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="title4">Title:</label>
                    <input type="text" class="form-control" name="title4" required>
                </div>
                <div class="form-group">
            ...
            <table class="table">
                ...
                <?php foreach ($portfolioItems as $item): ?>
                    <tr>
                        <td><img src="<?php echo $item['image_path4']; ?>" alt="" width="100"></td>
                        <td><?php echo $item['title4']; ?></td>
                        <td><?php echo $item['category4']; ?></td>
                        <td>
                            <form method="POST" style="display: inline;">
                                <input type="hidden" name="item_id" value="<?php echo $item['id4']; ?>">
                                <button type="submit" class="btn btn-danger" name="delete_item">Delete</button>
                            </form>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateModal<?php echo $item['id4']; ?>">Update</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            ...
            <!-- Update modal -->
            <?php foreach ($portfolioItems as $item): ?>
                <div class="modal fade" id="updateModal<?php echo $item['id4']; ?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?php echo $item['id4']; ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel<?php echo $item['id4']; ?>">Update Portfolio Item</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="title4">Title:</label>
                                        <input type="text" class="form-control" name="title4" value="<?php echo $item['title4']; ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="category4">Category:</label>
                                        <select class="form-control" name="category4" value="<?php echo $item['category4']; ?> " required>
                                            <option value="all" selected>All</option>
                                            <option value="Top Selling">Top selling</option>
                                            <option value="Budget Friendly">Budget Friendly</option>
