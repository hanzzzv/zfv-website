        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="reply-form">
              <h4 class="text-center mb-4">Sign your Digital Contract</h4>
              <form action="">
                <div class="row">
                ...
                <div class="form-group">
                  <input name="signature" type="text" class="form-control" placeholder="Your E-Signature" required>
                </div>
                <div class="form-group">
                  <input name="photo-url" type="url" class="form-control" placeholder="Your Valid Photo URL" required>
                </div>
                <div class="form-group">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        ...
        <div class="credits">
          ...
          Develop by <a href="#">ZFV Technologies</a>
        </div>
      </div>
