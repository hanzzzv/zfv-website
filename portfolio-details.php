...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logozfv.png" alt=""></a> -->
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="index.html"><span>Products</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="portfolio.php">Hardware Supplies</a></li>
              ...
              <li><a href="portfolio.php">Scaffoldings</a></li>
              <li><a href="portfolio.php">Plumbings</a></li>
             
              <li><a href="portfolio.php">Roofings</a></li>
              <li><a href="portfolio.php">Paints</a></li>
              <li><a href="portfolio.php">Electricals</a></li>
              <li><a href="portfolio.php">CCTVs </a></li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong>: Hardware Supplies</li>
                <li><strong>Client</strong>: ZFV Company</li>
