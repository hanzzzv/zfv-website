...
<div class="wrapper">
    ...
    <div class="main-container">
        ...
        if (isset($_POST['add_item'])) {
            ...
            $imagePath = 'uploads/' . $imageName; // Change 'uploads/' to your desired directory

            move_uploaded_file($imageTmpName, $imagePath);

            // Insert the new item into the database
            $query = "INSERT INTO portfolio_items (title, category, image_path) VALUES ('$title', '$category', '$imagePath')";
            mysqli_query($connection, $query);

            // Refresh the page to update the portfolio items
            echo '<script>window.location.href = "manage_hardwares.php";</script>';
            exit();
        }
        ...
        if (isset($_POST['delete_item'])) {
            ...
            $query = "SELECT image_path FROM portfolio_items WHERE id = '$itemID'";
            $result = mysqli_query($connection, $query);
        ...
        if (isset($_POST['update_item'])) {
            ...
            $query = "SELECT image_path FROM portfolio_items WHERE id = '$itemID'";
            $result = mysqli_query($connection, $query);
            $previousImagePath = mysqli_fetch_assoc($result)['image_path'];
            ...
            if ($_FILES['image']['name']) {
                ...
                $query = "UPDATE portfolio_items SET title = '$updatedTitle', category = '$updatedCategory', image_path = '$imagePath' WHERE id = '$itemID'";
            } else {
        ...
        <div class="container mt-5">
            <h2>Add New Hardware Supplies Item</h2>
            ...
            <table class="table">
                ...
                <?php foreach ($portfolioItems as $item): ?>
                    <tr>
                        <td><img src="<?php echo $item['image_path']; ?>" alt="" width="100"></td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateModal<?php echo $item['id']; ?>">Update</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            ...
            <!-- Update modal -->
            <?php foreach ($portfolioItems as $item): ?>
                <div class="modal fade" id="updateModal<?php echo $item['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?php echo $item['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel<?php echo $item['id']; ?>">Update Portfolio Item</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="category">Category:</label>
                                        <select class="form-control" name="category" value="<?php echo $item['category']; ?> " required>
                                            <option value="all" selected>All</option>
                                            <option value="Top Selling">Top selling</option>
                                            <option value="Budget Friendly">Budget Friendly</option>
