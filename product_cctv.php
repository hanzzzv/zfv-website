        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                <?php foreach ($portfolioItems as $item): ?>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo strtolower($item['category6']); ?>">
                        <div class="portfolio-wrap">
                            <img src="<?php echo $item['image_path6']; ?>" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4><?php echo $item['title6']; ?></h4>
                                <p><?php echo $item['category6']; ?></p>
                                <div class="portfolio-links">
                                    <a href="<?php echo $item['image_path6']; ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?php echo $item['title6']; ?>"><i class="bx bx-plus"></i></a>
